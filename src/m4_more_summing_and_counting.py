...
def run_test_count_cosines_from():
    ...
    expected = 1
    answer = count_cosines_from(3, 9, .79)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 5
    answer = count_cosines_from(1, 12, .20)
    ...
    expected = 6
    answer = count_cosines_from(0, 15, .50)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 1.42  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.81  # This is APPROXIMATELY the correct answer.
    ...
    # ------------------------------------------------------------------
    expected = 2.01  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 11)
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 2.36  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 100)
